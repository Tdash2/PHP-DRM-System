...
<?php 
$query = "SELECT hwid, actvationKey,id FROM UsedTrialHWID GROUP BY hwid";
?>
...
echo '<td><a class="buttonRed" href="/admin/deleteTrialHWID.php?id='  . $email . '">Delete HWID</a> </center></td>';
