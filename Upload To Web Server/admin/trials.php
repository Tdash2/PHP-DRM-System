...
<html>
<head>
<title><?php echo $appName; ?> Trial Actvation Key</title>
...
<?php 
$query = "SELECT * FROM `keys_table` WHERE isTrial != 1";
?>
<b> <center style="padding: 15pt;"  >All Trial Actvation Keys: </center> </b> <br> <br>
<?php
